...
#define _CD							__cdecl
#define IS_NEWWINGS(x)				((x < ITEM(12, 180)) ? FALSE : (x > ITEM(12, 280)) ? FALSE : TRUE)
...
#define pObjPreviewThis        ((DWORD)0x079B9D40)
#define CS_GET_STRUCT(x, y)	   (1124 * x + *(int*) y)




//#define HDK_SET_ITEM_EFFECT 0x004F321E //0x0052B0DB
//#define HDK_SET_COLOR_EFFECT 0x004F3380 //0x0052B122
...
#define HDK_SET_ITEM_EFFECT 0x004F321E
#define HDK_SET_COLOR_EFFECT 0x004F3380
#define HDK_ITEM_EFFECT_ALLOW 0x004F322A
#define HDK_ITEM_EFFECT_NOT_ALLOW 0x004F38C9
#define HDK_NEXT_ITEM_COLOR 0x004F33AF
#define HDK_SET_LEVEL_EFFECT 0x004F377D
#define HDK_NEXT_LEVEL_EFFECT 0x004F38A5
