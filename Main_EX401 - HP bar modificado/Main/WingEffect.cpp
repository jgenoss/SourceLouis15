...
Naked(AddWingsEffect)
{
	...
	if (IsCustomWings(AddWingsEffect_Buff, true))
	{
		...
		_asm
		{
			mov AddWingsEffect_Buff, 0x004E9D52
	...
	if (AddWingsEffect_Buff > 0x0A9D)
	{
		_asm
		{
			mov AddWingsEffect_Buff, 0x004E447D
				jmp AddWingsEffect_Buff
		}
	}
	// ----
	_asm
	{
		mov AddWingsEffect_Buff, 0x004E4442
			jmp AddWingsEffect_Buff
	}
}
...
void WingEffect()
{
	SetRange((LPVOID)0x004E4436, 10, ASM::NOP);
	SetOp((LPVOID)0x004E4436, AddWingsEffect, ASM::JMP);
}

//0056CA63  004E9D52 
//005667BB  004E447D ok
//00566707  004E4442 ok
//005666F7  004E4436 ok