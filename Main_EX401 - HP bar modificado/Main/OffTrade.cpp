...
void cOffTrade::Init()
{
	SetCompleteHook(0xFF, 0x005868C3, &this->ShowPrice);

	SetCompleteHook(0xFF, 0x005869F6, &this->ShowTwoString);

	SetCompleteHook(0xE9,0x0058691A,&ChangePSValueColor);
}

__declspec(naked) void ChangePSValueColor()
{
	static DWORD AdressFinal = 0x00586921;
	_asm
	{
