...
BOOL CDynamicWingEffect::DynamicWingEffect(int ItemIndex,DWORD a,DWORD b,DWORD c) // OK
{
	for(int n=0;n < this->count;n++)
	{
		...
		if(this->m_DynamicWingEffectInfo[n].ItemIndex == ItemIndex)
		{
			...
			((void(__thiscall*)(void*,DWORD,DWORD,DWORD,DWORD))0x004C69C9)((void*)a,b,c,this->m_DynamicWingEffectInfo[n].EffectValue,this->m_DynamicWingEffectInfo[n].EffectLevel);
			((void(*)(DWORD,DWORD,DWORD,float*,DWORD,float,DWORD))0x00685A69)(this->m_DynamicWingEffectInfo[n].EffectIndex,b,c,ItemColor,this->m_DynamicWingEffectInfo[n].Effect1,this->m_DynamicWingEffectInfo[n].Effect,this->m_DynamicWingEffectInfo[n].Effect2);
		}
	}
	return 0;
}