...
BOOL CCustomWingEffect::SetWingEffect(int ItemIndex,DWORD a,DWORD b,DWORD c,DWORD d) // OK
{
	for(int n=0;n < MAX_CUSTOM_WING_EFFECT;n++)
	{
		...
		if(this->m_CustomWingEffectInfo[n].ItemIndex == ItemIndex)
		{
			...
			((void(*)(DWORD,DWORD,float,float*,DWORD,float,DWORD))0x006A33B2)(this->m_CustomWingEffectInfo[n].EffectIndex,b,this->m_CustomWingEffectInfo[n].ColorSize,ItemColor,d,this->m_CustomWingEffectInfo[n].ColorMain,(DWORD)this->m_CustomWingEffectInfo[n].ColorSide);
		}
		...
		if(gDynamicWingEffect.m_DynamicWingEffectInfo[n].ItemIndex == ItemIndex)
		{
			...
			((void(__thiscall*)(void*,DWORD,DWORD,DWORD,DWORD))0x004C69C9)((void*)a,b,c,gDynamicWingEffect.m_DynamicWingEffectInfo[n].EffectValue,gDynamicWingEffect.m_DynamicWingEffectInfo[n].EffectLevel);
			((void(*)(DWORD,DWORD,DWORD,float*,DWORD,float,DWORD))0x00685A69)(gDynamicWingEffect.m_DynamicWingEffectInfo[n].EffectIndex,b,c,ItemColor,gDynamicWingEffect.m_DynamicWingEffectInfo[n].Effect1,gDynamicWingEffect.m_DynamicWingEffectInfo[n].Effect,gDynamicWingEffect.m_DynamicWingEffectInfo[n].Effect2);
		}
	}
...
//	{
//
//		if (this->m_CustomWingEffectInfo[n].Index == -1)
//		{
//			return 0;
//		}
//
