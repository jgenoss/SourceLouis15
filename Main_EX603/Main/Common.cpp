...
//
	gInterface.DrawFormat(eYellow, (MAX_WIN_WIDTH / 2) - 74, 470, 100, 3, "Louis Emulator");
//	
//	gInterface.DrawFormat(eYellow, (MAX_WIN_WIDTH / 2) + 250, 470, 100, 3, "LTP-TEAM.RU");
	...
	//if(pMapNumber == 0x49 || pMapNumber == 0x5E)
	//{
	//	g_NewsSystem->Render();
	//}
